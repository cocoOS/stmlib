...
#define RCC_AHBPeriph_ADC34 0
#define RCC_AHBPeriph_ADC12 0
...
#define RCC_AHBPeriph_GPIOF 0
#define RCC_AHBPeriph_TS 0
#define RCC_AHBPeriph_CRC 0
#define RCC_AHBPeriph_FLITF 0
#define RCC_AHBPeriph_SRAM 0
#define RCC_AHBPeriph_DMA2 0
...
#define USART_IT_ORE    1
#define USART_IT_NE     2
#define USART_IT_FE     3
#define USART_IT_PE     4
#define USART_IT_ERR    5
#define USART_IT_TXE    6
#define USART_OVRDetection_Enable 0
...
typedef uint16_t USART_ClockInitTypeDef;

typedef uint16_t ITStatus;
