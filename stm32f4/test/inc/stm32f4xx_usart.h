...
#define USART_IT_TC                          ((uint16_t)0x0003)
#define USART_IT_RXNE                        ((uint16_t)0x4)
#define USART_IT_ORE_RX                      ((uint16_t)0x5) /* In case interrupt is generated if the RXNEIE bit is set */
#define USART_IT_IDLE                        ((uint16_t)0x6)
#define USART_IT_LBD                         ((uint16_t)0x7)
#define USART_IT_CTS                         ((uint16_t)8)
#define USART_IT_ERR                         ((uint16_t)9)
#define USART_IT_ORE_ER                      ((uint16_t)10) /* In case interrupt is generated if the EIE bit is set */
#define USART_IT_NE                          ((uint16_t)11)
#define USART_IT_FE                          ((uint16_t)12)
